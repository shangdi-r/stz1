"use strict";
    ...
    */
    ...
    function loadInitialFile() {
     ...
     //puzzle.srcImage.src = "delete/img.heic";
      puzzle.srcImage.src = imageLis[randImg];
    ...
    let menu = (function () {
      ...
      for (let k = 4; k < menu.items.length; ++k) {
        menu.items[k].element.addEventListener("click", () => events.push({ event: "nbpieces", nbpieces: [8, 11, 16, 19, 30, 45, 70, 120][k - 4] }));
      }
      return menu;
    })();
